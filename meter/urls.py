...
from .views import MeterListCreateView, MeterDetailView, GenerateMeterTokenView, UtilityCostListCreateView, UtilityCostUpdateDeleteView, UtilityVendsListView, UtilityVendDetailView
...
urlpatterns = [
    ...
    path('organizations/<uuid:org_uuid>/utility-vends/<uuid:vend_uuid>/', UtilityVendDetailView.as_view(), name='utility-vend-detail')
]
